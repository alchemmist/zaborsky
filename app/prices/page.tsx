...
export const metadata: Metadata = {
  ...
  description: "Цены на заборы в Магнитогорске и Челябинской области: жалюзи от 132 руб/п.м, евроштакетник от 127 руб/п.м, металлопланкен от 160 руб/п.м. Монтаж на месте, доставка по России.",
  alternates: {
