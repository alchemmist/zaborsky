...
export async function POST(req: Request) {
  ...
  if (typeof body.addressDescription === "string") patch.addressDescription = body.addressDescription;
  if (typeof body.addressImage === "string") patch.addressImage = body.addressImage;
