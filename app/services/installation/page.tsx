...
export const metadata: Metadata = {
  ...
  description: "Установка заборов под ключ в Магнитогорске, Челябинской области и Башкирии. Бесплатный замер, гарантия на монтаж. Цена установки от 500 руб/п.м. Работаем с любыми типами заборов.",
  alternates: {
