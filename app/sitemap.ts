...
const routes = [
  ...
  { url: `${siteUrl}/fences/gates/`, priority: 0.6, changeFrequency: "weekly" as const },
  ...
  { url: `${siteUrl}/landscaping/terrace-board/`, priority: 0.5, changeFrequency: "monthly" as const },
