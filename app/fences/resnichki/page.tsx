...
export const metadata: Metadata = {
  ...
  description: "Купить забор-жалюзи Реснички в Магнитогорске и Челябинской области — с монтажом под ключ. Белый, тёмный шоколад, серый графит, доставка по России.",
  alternates: {
