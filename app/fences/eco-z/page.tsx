...
export const metadata: Metadata = {
  ...
  description: "Забор-жалюзи ЭКО-Z и усиленные ЭКО-Z US: купить с монтажом под ключ, цена от 188 руб/п.м. Серый графит, шоколад, белый, принтек, доставка по России.",
  alternates: {
